...
parser.add_argument("-model", default='Heisenberg', choices=['maple_leaf', 'Heisenberg', 'SO(4)'], help="model name")
parser.add_argument("-load", default=None, help="load wavefunction file")
parser.add_argument("-save_period", type=int, default=1, help="")
parser.add_argument("-Jh", type=float, default=0.0, help="Jh") 
parser.add_argument("-Jd", type=float, default=1.0, help="Jd") 
parser.add_argument("-Jt", type=float, default=0.12, help="Jt") 
